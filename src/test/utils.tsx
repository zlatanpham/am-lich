...
export const mockTRPCError = (message: string, code: 'BAD_REQUEST' | 'UNAUTHORIZED' | 'NOT_FOUND' | 'INTERNAL_SERVER_ERROR' = 'BAD_REQUEST') => {
  return new TRPCClientError(message, {
    result: {
      error: {
        ...
        data: {
          code,
          httpStatus: code === 'BAD_REQUEST' ? 400 : code === 'UNAUTHORIZED' ? 401 : code === 'NOT_FOUND' ? 404 : 500,
        },
      },
    },
  })
